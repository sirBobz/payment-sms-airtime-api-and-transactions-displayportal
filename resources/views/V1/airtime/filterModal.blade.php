          <!-- The Modal -->
          <div class="modal" id="airtimeQueryByParams">
              <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <form method="get" autocomplete="off" action="{{ route('admin.airtime.index')}}">
                              {{ csrf_field() }}
                              <div class="row">

                              <div class="col-lg-6 col-sm-6 col-xs-6">
                                  <div class="form-group{{ $errors->has('telco_name') ? ' has-error' : '' }}">
